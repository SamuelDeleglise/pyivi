...
#define IVISPECAN_ATTR_TRACE_SIZE                                    (IVI_CLASS_PUBLIC_ATTR_BASE + 19L)   /* ViInt32 , Multi-Trace */
#define IVISPECAN_ATTR_TRACE_TYPE                                    (IVI_CLASS_PUBLIC_ATTR_BASE + 20L)   /* ViInt32 , Multi-Trace */
